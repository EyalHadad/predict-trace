...
def scan_csv(path):
    with open(path) as  csv_file:
        ...
        for i in range(len(content)):
            ...
            if len(content[i]) > 0 and 'Bug' in content[i][0] and 'Eyal' in content[i+6][0] and 'Random' in content[i+11][0]:
        ...
        average_number_of_steps = ["Amir:", amir_length_count / divide, "Eyal:",  eyal_length_count / divide, "Random:", random_length_count / divide]
        average_last_core = ["Amir:", amir_last_score_sum / divide, "Eyal:", eyal_last_score_sum / divide, "Random:" , random_last_score_sum / divide]
